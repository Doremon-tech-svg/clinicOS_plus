...
import { Bed, Users, Info, X, Activity, User, CheckCircle2 } from "lucide-react";
...
export function WardView({ patients, bedCount, rawBeds = [] }) {
  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", gap: 20 }}>
      <div style={{ fontWeight: 800, fontSize: 16, display: "flex", alignItems: "center", gap: 7, color: "#1e293b" }}>
        <Bed size={18} color={WARD_COLOR} /> Hospital Ward Overview
      </div>
